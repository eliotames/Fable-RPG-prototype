 ...
 *
 * Generated textures:
 *  - 'tiles': a 1-row isometric tile sheet (64×32 per tile) used by the tilemap.
...
export class BootScene extends Phaser.Scene {
  ...
  makeTileSheet() {
    ...
    defs.forEach((d, i) => {
      ...
      const outer = diamond(cx, cy, W - 1, H - 1);
      g.fillStyle(d.fill, 1);
      g.fillPoints(outer, true);
      g.lineStyle(1, d.edge, 1);
