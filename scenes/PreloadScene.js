...
export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const barBg = this.add.rectangle(640, 360, 420, 14, 0x22242c).setStrokeStyle(1, Colors.panelEdge);
    const bar = this.add.rectangle(640 - 208, 360, 1, 10, Colors.accent).setOrigin(0, 0.5);
    this.add.text(640, 330, 'Loading content…', uiStyle({ fontSize: '16px' })).setOrigin(0.5);
    this.load.on('progress', (v) => bar.setSize(Math.max(1, 416 * v), 10));
